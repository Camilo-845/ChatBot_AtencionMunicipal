...
CREATE OR REPLACE FUNCTION crear_solicitud_pqrd(
    correo_electronico VARCHAR(100),
    tipo_solicitud tipo_solicitud_enum,
    informacion_solicitud VARCHAR(5098),
    tipo_persona tipo_persona_enum DEFAULT NULL,
    primer_nombre VARCHAR(50) DEFAULT NULL,
    segundo_nombre VARCHAR(50) DEFAULT NULL,
    primer_apellido VARCHAR(50) DEFAULT NULL,
...
DECLARE
    ...
    seguimiento VARCHAR(50);
BEGIN
    -- Validar que correo electrónico, tipo_solicitud e informacion_solicitud no sean nulos
    IF correo_electronico IS NULL OR tipo_solicitud IS NULL OR informacion_solicitud IS NULL THEN
        RAISE EXCEPTION 'correo_electronico, tipo_solicitud e informacion_solicitud son obligatorios';
    END IF;
    ...
    -- Insertar en la tabla PQRDS
    INSERT INTO PQRDS (
        id_solicitud, estado, tipo_solicitud, informacion_solicitud
    ) VALUES (
        solicitud_id, 'Pendiente', tipo_solicitud, informacion_solicitud
    );
